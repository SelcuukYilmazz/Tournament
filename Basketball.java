...
public class Basketball extends Basketcalculate{
    /*Basketbol Objesi*/
    String teamsname;
    String teamskind;
    int teamsscore;
    ...
    public Basketball(String teamsname, String teamskind, int teamsscore, int playedmatch, int win, int even, int loss, int matchscore, int rivalmatchscore, int difference) {
        this.teamsname = teamsname;
        this.teamskind = teamskind;
        this.teamsscore = teamsscore;
        this.playedmatch = playedmatch;
