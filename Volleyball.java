//package quiz2
public class Volleyball extends Voleycalculate{
    /* Voleybol Objesi*/
    String teamsname;
    String teamskind;
    int teamsscore;
    ...
    public Volleyball(String teamsname, String teamskind, int teamsscore, int playedmatch, int win, int even, int loss, int matchscore, int rivalmatchscore, int difference) {
        this.teamsname = teamsname;
        this.teamskind = teamskind;
        this.teamsscore = teamsscore;
        this.playedmatch = playedmatch;
